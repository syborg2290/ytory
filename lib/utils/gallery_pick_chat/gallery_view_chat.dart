...
class GalleryViewChat extends StatefulWidget {
  GalleryViewChat({Key key}) : super(key: key);

  @override
  _GalleryViewChatState createState() => _GalleryViewChatState();
}

class _GalleryViewChatState extends State<GalleryViewChat> {
